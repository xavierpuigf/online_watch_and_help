...
def main(cfg: DictConfig):
    ...
    if not args.debug:
        cachedir = f"{get_original_cwd()}/outputs/helping_empowerment_fastwalk_r{int(args.reset_steps)}_{int(args.small_set)}_{args.num_tries}_ip{int(args.inv_plan)}_{network_name}_{args.num_samples}_{args.alpha}_{args.beta}_{args.lam}"
    else:
        cachedir = f"{get_original_cwd()}/outputs/debug_helping_empowerment_fastwalk_r{int(args.reset_steps)}_{int(args.small_set)}_{args.num_tries}_ip{int(args.inv_plan)}_{network_name}_{args.num_samples}_{args.alpha}_{args.beta}_{args.lam}"
