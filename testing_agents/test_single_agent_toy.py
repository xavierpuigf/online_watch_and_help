...
if __name__ == '__main__':
    ...
    num_tries = 10
    args.executable_file = '/data/vision/torralba/frames/data_acquisition/SyntheticStories/website/release/simulator/v2.0/v2.2.5_beta/linux_exec.v2.2.5_beta3.x86_64'
