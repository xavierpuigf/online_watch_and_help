...
parser.add_argument('--task', type=str, default='setup_table_toy', help='Task name')
parser.add_argument('--apt_str', type=str, default='5,6', help='The apartments where we will generate the data')
parser.add_argument('--port', type=str, default='8094', help='Task name')
...
if __name__ == "__main__":
    ...
    ## gen graph
    ## -------------------------------------------------------------
    task_names = {1: ["setup_table_toy", "setup_table", "clean_table", "put_fridge", "prepare_food", "read_book", "watch_tv"],
                  2: ["setup_table_toy", "setup_table", "clean_table", "put_dishwasher", "unload_dishwasher", "put_fridge", "prepare_food",
                      "read_book", "watch_tv"],
                  3: ["setup_table_toy", "setup_table", "clean_table", "put_dishwasher", "unload_dishwasher", "put_fridge", "prepare_food",
                      "read_book", "watch_tv"],
                  4: ["setup_table_toy", "setup_table", "clean_table", "put_dishwasher", "unload_dishwasher", "put_fridge", "prepare_food",
                      "read_book", "watch_tv"],
                  5: ["setup_table_toy", "setup_table", "clean_table", "put_dishwasher", "unload_dishwasher", "put_fridge",
                      "prepare_food"],
                  6: ["setup_table_toy", "setup_table", "clean_table", "put_fridge", "prepare_food", "read_book", "watch_tv"],
                  7: ["setup_table_toy", "setup_table", "clean_table", "put_dishwasher", "unload_dishwasher", "put_fridge", "prepare_food",
                      "read_book", "watch_tv"]}
    ...
    elif args.task == 'setup_table_toy':
        tasks = ['setup_table_toy_1', 'setup_table_toy_2']
    else:
        tasks = [args.task]
    ...
    pickle.dump(env_task_set, open(f'{curr_dir}/../dataset/{args.split}_env_task_set_{args.num_per_apartment}_{args.mode}.pik', 'wb'))
